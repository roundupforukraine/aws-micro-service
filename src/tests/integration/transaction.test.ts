...
describe('Transaction API', () => {
  ...
  beforeAll(async () => {
    ...
    // Create a test organization using the mock client to get a valid API key
    const testOrgData = { name: 'Transaction Test Org', isAdmin: false };
    const createdOrg = await prismaTestClient.organization.create({ data: testOrgData }) as Organization;
    apiKey = createdOrg.apiKey; // Use the key generated by the mock
    organizationId = createdOrg.id;

    // Create a test transaction using the obtained apiKey
